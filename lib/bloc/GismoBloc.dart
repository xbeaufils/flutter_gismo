...
import 'package:gismo/bloc/GismoRepository.dart';
  ...
  */
  ...
  Future<List<Event>> getEventsForLamb(LambModel lamb) async {
    try {
      ...
      lstTraits.forEach((traitement) {lstEvents.add(new Event(traitement.idBd!, EventType.traitement,  traitement.debut, traitement.medicament)); });
      return lstEvents;
    }
    catch(e, stackTrace) {
