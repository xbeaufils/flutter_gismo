...
class TimeLineViewModel extends ChangeNotifier {
  ...
  TimeLinePresenter(TimelineContract view) {
  ...
  void _editLambing(LambingModel lambing) async {
    String ? message = await this._view.editPage(LambingPage.edit(lambing));
    if (message != null)
      this._view.showMessage(message);
  }

  void _editTraitement(TraitementModel traitement) async {
    String ? message = await this._view.editPage(SanitairePage.edit(traitement));
    if (message != null)
      this._view.showMessage(message);
  }
  ...
  void _editMemo(MemoModel note) async {
    String ? message = await this._view.editPage(MemoPage.edit(note));
    if (message != null)
      this._view.showMessage(message);
  }
